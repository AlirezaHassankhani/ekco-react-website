...
export default function UserPanel() {
  ...
  return (
    <>
      <header className="header-panel fixed-top z-2">
      ...
      {statusOfMenu && (
        <div className="position-fixed top-0 bottom-0 start-0 end-0 z-3 d-flex">
          <div className="sidebar-panel top-0 z-3">
            <div
              ...
              <ul className="list-unstyled p-2">
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="ir-light fs-dominant">نتایج آزمون ها</span>
                  </Link>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="ir-light fs-dominant">ویرایش پروفایل</span>
                  </Link>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="ir-light fs-dominant">تغییر رمز عبور</span>
                  </Link>
                </li>
