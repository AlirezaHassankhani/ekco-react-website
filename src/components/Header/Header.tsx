  ...
  return (
    <>
      <header className="header">
        <div className="header__content bg-primary">
          <div className="container-md pb-5">
            <section>
              <nav className="d-flex justify-content-between align-items-center">
                <button
                  onClick={() => setStatusOfMenu(true)}
                  className="d-lg-none btn fs-3 text-white"
                >
                  <svg
                ...
                <div className="d-flex align-items-center">
                  ...
                  <ul className="nav d-none d-lg-flex fs-dominant">
                    <li className="nav-item">
                      <Link
                        className="nav-link text-white ir-light header__link"
                        to="/exams"
                      >
                        آزمون ها
                      </Link>
                ...
                <div className="d-none d-lg-flex">
                  <Link
                    to="/login"
                    className="text-black bg-gary ir-light fs-dominant header__login rounded-pill me-1"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                  ...
                  <Link
                    to="/shopping-cart"
                    className="text-black bg-gary ir-light fs-dominant header__basket rounded-pill"
                  >
                    <span>سبد خرید</span>
                ...
                <Link
                  to="/shopping-cart"
                  className="d-lg-none text-black bg-white ir-light header__icon-phone rounded-pill"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                  ...
                  >
                    <SwiperSlide>
                      <img
                        ...
                        className="img-fluid header__image"
                      />
                    </SwiperSlide>
        ...
        {statusOfMenu && (
          <div className="position-fixed top-0 bottom-0 start-0 end-0 z-3 d-flex">
            <div className="phone-menu">
              ...
              <div className="phone-menu__search-box ir-light text-black bg-gary">
                <input placeholder="جستجو..." />
                <i className="fa-regular fa-magnifying-glass"></i>
              </div>

              <div className="phone-menu__group-btn my-3 py-2">
                <Link to="/login" className="text-black bg-gary ir-light me-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                ...
                <Link
                  to="/shopping-cart"
                  className="text-black bg-gary ir-light"
                >
                  <span>سبد خرید</span>
              ...
              <ul className="nav flex-column ir">
                <li className="nav-item">
                  <Link className="nav-link text-dark" to="/exams">
                    آزمون ها
                  </Link>
                </li>
                <li className="nav-item">
                  <Link className="nav-link text-dark" to="/questions">
                    سوالات متداول
                  </Link>
                </li>
                <li className="nav-item">
