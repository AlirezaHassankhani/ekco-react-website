            ...
            <div className="container-md py-5">
              <div className="d-flex flex-wrap">
                <div className="col-12 col-lg-4">
                  ...
                  <p className="footer__dis text-white ir-light">
                    اکو آزمون، حاصل تلاش جمعی و تجربه چند ساله تیم نرم
                    افزاری رایانیک در پیاده سازی سامانه های آزمون آنلاین می باشد
                    که هم اکنون به صورت یک محصول آماده فروش می باشد.
                  </p>
                ...
                <div className="col-12 col-lg-4 pt-4 ps-4">
                  <p className="text-white ir">دسترسی سریع</p>
                  
                  <ul className="footer__nav">
                    <li className="mb-2">
                      <Link to="/exams" className="ir-light">
                        آزمون ها
                      </Link>
                    </li>
                    <li className="mb-2">
                      <Link to="/about-us" className="ir-light">
                        درباره ما
                      </Link>
                    </li>
                    <li className="mb-2">
                      <Link to="/contact-us" className="ir-light">
                        تماس با ما
                      </Link>
                    </li>
                  </ul>
